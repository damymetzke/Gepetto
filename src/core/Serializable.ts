export type SerializeValue = SerializeObject | SerializeArray | number | string | boolean | null;
 ...
 * 
 * serialized objects are still in JS objects, to use it as a string call `JSON.stringify(serialized)`,
