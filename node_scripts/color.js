...
const WARN = [EFFECTS["FG_YELLOW"]];
const ERROR = [EFFECTS["FG_RED"]];
const FILE = [EFFECTS["FG_CYAN"], EFFECTS["UNDERLINE"]];
const HEADER = [EFFECTS["FG_MAGENTA"], EFFECTS["BOLD"], EFFECTS["UNDERLINE"]];
